...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "InteplastLLM var strādāt ar daudziem LLM pakalpojumu sniedzējiem. Šis būs pakalpojums, kas apstrādās sarunas.",
    },
    userSetup: {
    ...
    survey: {
      ...
      description:
        "Palīdziet mums veidot InteplastLLM atbilstoši jūsu vajadzībām. Neobligāti.",
    ...
    workspace: {
      ...
      description:
        "Izveidojiet savu pirmo darba telpu un sāciet darbu ar InteplastLLM.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Laipni lūgti AnythingLLM, InteplastLLM ir Mintplex Labs izstrādāts atvērtā koda AI rīks, kas pārvērš jebko par apmācītu čatbotu, kuru varat izmantot vaicājumiem un sarunām. InteplastLLM ir BYOK (bring-your-own-keys) programmatūra, tāpēc nav abonēšanas, maksas vai papildu maksājumu par šo programmatūru, izņemot pakalpojumus, kurus vēlaties izmantot ar to.",
    part2:
      "InteplastLLM ir vienkāršākais veids, kā apvienot spēcīgus AI produktus, piemēram, OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB un citus pakalpojumus, kārtīgā paketē bez liekas piepūles, lai palielinātu savu produktivitāti 100 reizes.",
    part3:
      "InteplastLLM var darboties pilnībā lokāli jūsu datorā ar minimālu piepūli, jūs pat nepamanīsiet tā klātbūtni! GPU nav nepieciešams. Pieejama arī mākoņa un lokālā instalācija.\nAI rīku ekosistēma kļūst spēcīgāka ar katru dienu. InteplastLLM to padara viegli izmantojamu.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Jūs esat ceļā, lai kļūtu par InteplastLLM ekspertu!",
      dismiss: "aizvērt",
      tasks: {
        create_workspace: {
  ...
  general: {
    ...
    message: {
      ...
      body: "InteplastLLM priekšrocības",
    },
    pfp: {
  ...
  customization: {
    interface: {
      ...
      description: "Iestatiet savas UI preferences InteplastLLM.",
    },
    branding: {
      title: "Zīmolrade un identitāte",
      description:
        "Pielāgojiet savu InteplastLLM instanci ar pielāgotu zīmolradi.",
    },
    chat: {
      title: "Saruna",
      description: "Iestatiet savas sarunas preferences InteplastLLM.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Izvēlieties vēlamo valodu InteplastLLM lietotāja saskarnei - kad pieejami tulkojumi.",
      },
      logo: {
      ...
      "welcome-messages": {
        ...
        user: "lietotājs",
        message: "ziņojums",
        assistant: "InteplastLLM čata asistents",
  ...
  api: {
    title: "API atslēgas",
    description:
      "API atslēgas ļauj to īpašniekam programmatiski piekļūt un pārvaldīt šo InteplastLLM instanci.",
  ...
  llm: {
    title: "LLM preferences",
    description:
      "Šie ir akreditācijas dati un iestatījumi jūsu vēlamajam LLM čata un iegulšanas pakalpojuma sniedzējam. Ir svarīgi, lai šīs atslēgas būtu aktuālas un pareizas, pretējā gadījumā InteplastLLM nedarbosies pareizi.",
  ...
  embedding: {
    ...
    "desc-end":
      "Iegulšana ir process, ar kuru teksts tiek pārveidots vektoros. Šie akreditācijas dati ir nepieciešami, lai pārveidotu jūsu failus un vaicājumus formātā, kuru InteplastLLM var izmantot apstrādei.",
    provider: {
      title: "Iegulšanas pakalpojuma sniedzējs",
      description:
        "Nav nepieciešama iestatīšana, izmantojot InteplastLLM iebūvēto iegulšanas dzinēju.",
    },
  },
  text: {
  ...
  vector: {
    ...
    description:
      "Šie ir akreditācijas dati un iestatījumi tam, kā darbosies jūsu InteplastLLM instance. Ir svarīgi, lai šīs atslēgas būtu aktuālas un pareizas.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Aizsargājiet savu InteplastLLM instanci ar paroli. Ja aizmirsīsiet šo paroli, nav atgūšanas metodes, tāpēc pārliecinieties, ka saglabājat šo paroli.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Šī ir jūsu konfigurācija tam, kā savienotie trešo pušu pakalpojumu sniedzēji un InteplastLLM apstrādā jūsu datus.",
    llm: "LLM izvēle",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Šie faili tiks augšupielādēti dokumentu apstrādātājā, kas darbojas šajā InteplastLLM instancē. Šie faili netiek nosūtīti vai kopīgoti ar trešo pusi.",
    },
    pinning: {
      ...
      pin_explained_block3:
        "Ja jūs nesaņemat vēlamās atbildes no InteplastLLM pēc noklusējuma, tad piespraušana ir lielisks veids, kā iegūt kvalitatīvākas atbildes ar vienu klikšķi.",
      accept: "Labi, sapratu",
    },
    watching: {
