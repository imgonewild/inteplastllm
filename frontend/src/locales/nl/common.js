...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Welkom bij AnythingLLM, InteplastLLM is een open-source AI-tool van Mintplex Labs die alles omzet in een getrainde chatbot waarmee je kunt vragen en chatten. InteplastLLM is een BYOK (bring-your-own-keys) software, dus er is geen abonnement, vergoeding of kosten voor deze software buiten de diensten die je ermee wilt gebruiken.",
    part2:
      "InteplastLLM is de eenvoudigste manier om krachtige AI-producten zoals OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB en andere diensten samen te voegen in een net pakket zonder gedoe om je productiviteit met 100x te verhogen.",
    part3:
      "InteplastLLM kan volledig lokaal op je machine draaien met weinig overhead, je merkt niet eens dat het er is! Geen GPU nodig. Cloud en on-premises installatie is ook beschikbaar.\nHet AI-tooling ecosysteem wordt elke dag krachtiger. InteplastLLM maakt het gemakkelijk te gebruiken.",
  ...
  llm: {
    title: "LLM Voorkeur",
    description:
      "Dit zijn de inloggegevens en instellingen voor je voorkeurs LLM-chat & inbeddingprovider. Het is belangrijk dat deze sleutels actueel en correct zijn, anders zal InteplastLLM niet goed werken.",
  ...
  transcription: {
    ...
    "warn-start":
      "Het gebruik van het lokale fluistermodel op machines met beperkte RAM of CPU kan InteplastLLM vertragen bij het verwerken van mediabestanden.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Inbedding is het proces van het omzetten van tekst in vectoren. Deze inloggegevens zijn vereist om je bestanden en prompts om te zetten naar een formaat dat InteplastLLM kan gebruiken om te verwerken.",
    provider: {
      title: "Inbedding Provider",
      description:
        "Er is geen instelling vereist bij gebruik van de ingebouwde inbeddingengine van InteplastLLM.",
    },
  },
  text: {
  ...
  privacy: {
    ...
    description:
      "Dit is je configuratie voor hoe verbonden derden en InteplastLLM je gegevens verwerken.",
    llm: "LLM Selectie",
