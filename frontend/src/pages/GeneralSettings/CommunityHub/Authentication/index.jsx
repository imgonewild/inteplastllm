...
function useCommunityHubAuthentication() {
  ...
  async function disconnectHub() {
    ...
    try {
      ...
      setHasChanges(false);
      showToast("Disconnected from InteplastLLM Community Hub", "success");
          ...
          <div className="w-full flex flex-col gap-y-1 pb-6 border-white light:border-theme-sidebar-border border-b-2 border-opacity-10">
            <div className="items-center">
              <p className="text-lg leading-6 font-bold text-theme-text-primary">
                Your InteplastLLM Community Hub Account
              </p>
            </div>
              ...
              <div className="flex flex-col gap-y-2">
                <div className="gap-x-2 flex items-center">
                  ...
                  <h1 className="text-lg font-semibold">
                    Why connect my InteplastLLM Community Hub account?
                  </h1>
                </div>
                <p className="text-sm text-theme-text-secondary">
                  Connecting your InteplastLLM Community Hub account allows you
                  to pull in your <b>private</b> items from the AnythingLLM
                  Community Hub as well as upload your own items to the
                  InteplastLLM Community Hub.
                  <br />
                  <br />
                  <i>
                    You do not need to connect your InteplastLLM Community Hub
          ...
          <div className="mt-6 mb-12">
            <div className="flex flex-col w-full max-w-[400px]">
              ...
              <input
                ...
                placeholder="Enter your InteplastLLM Hub API key"
              />
              <div className="flex items-center justify-between mt-2">
                <p className="text-theme-text-secondary text-xs">
                  ...
                  >
                    InteplastLLM Community Hub profile page
                  </a>
                  .
                </p>
                {!!originalConnectionKey && (
