...
/**
 * An interface to the InteplastLLM Community Hub external API.
 */
const CommunityHub = {
   ...
   * so we can unzip and import them to the InteplastLLM instance.
  ...
  /**
   * Apply an item to the InteplastLLM instance. Used for simple items like slash commands and system prompts.
  ...
  /**
   * Import a bundle item to the InteplastLLM instance by downloading the zip file and importing it.
