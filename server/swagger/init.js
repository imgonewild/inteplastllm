...
const doc = {
  info: {
    version: "1.0.0",
    title: "InteplastLLM Developer API",
    description:
      "API endpoints that enable programmatic reading, writing, and updating of your InteplastLLM instance. UI supplied by Swagger.io.",
  },
